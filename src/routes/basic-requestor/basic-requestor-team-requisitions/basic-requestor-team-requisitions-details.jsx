...
// ******************************************************* ALL CONTEXT************************************************************
    const {basicRequestorTeamRequisitionsNomindatedBiddersColumns, basicRequestorTeamRequisitionsNomindatedBiddersData} = useContext(BasicRequestorContext)
            ...
            <div className="border border-primaryBlue">
                ...
                <div className="container px-4 py-3 space-y-3">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <ReactTable columns={basicRequestorTeamRequisitionsNomindatedBiddersColumns} data={basicRequestorTeamRequisitionsNomindatedBiddersData}/>
                        </div>
