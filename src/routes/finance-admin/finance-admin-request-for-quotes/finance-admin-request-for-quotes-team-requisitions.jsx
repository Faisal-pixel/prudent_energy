...
const FinanceAdminRequestForQuotesTeamRequisitions = () => {
    const {financeAdminRequestForQuotesUnderlinedNavigations, financeAdminRequestForQuotesTeamRequisitionsData, financeAdminRequisitionsColumns} = useContext(FinanceAdminContext);
    ...
    const filteredTeamRequisitionsData = financeAdminRequestForQuotesTeamRequisitionsData.filter((data) => (
    ...
    return <>
        <div className="container bg-secondaryBackground overflow-y-scroll space-y-5 px-6 pt-6">
            ...
            <div className="bg-white px-3 py-4">
                ...
                <ReactTable columns={financeAdminRequisitionsColumns} data={filteredTeamRequisitionsData} goTo={"details"}/>
            </div>
...
export default FinanceAdminRequestForQuotesTeamRequisitions;