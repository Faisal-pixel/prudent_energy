...
const ManagementMyPurchaseContractsDetails = () => {
    const {uploadedFilesPurchaseContracts} = useContext(ManagementContext)
    return (
...
export default ManagementMyPurchaseContractsDetails;