...
const ProcurementAdminRecentRequisitionsDetails = () => {
    // **************************************** USE MEMO HOOK *********************************
...
// ******************************************************* ALL CONTEXT************************************************************
    const {procurementAdminNominatedBiddersColumns, procurementAdminDashboardRecentRequisitionsNominatedBiddersData} = useContext(ProcurementAdminContext)
            ...
            <div className="border border-primaryBlue">
                ...
                <div className="container px-4 py-3 space-y-3">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <ReactTable columns={procurementAdminNominatedBiddersColumns} data={procurementAdminDashboardRecentRequisitionsNominatedBiddersData}/>
                        </div>
...
export default ProcurementAdminRecentRequisitionsDetails;