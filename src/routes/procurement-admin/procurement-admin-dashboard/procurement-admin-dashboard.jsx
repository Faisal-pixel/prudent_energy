...
import ProcurementItFinanceManagementDashboardTemplateComponent from "../../../components/procurement-it-finance-management-dashboard-template.component";
const ProcurementAdminDashboard = () => {
    ...
    return (
        ...
        // </div>
        <ProcurementItFinanceManagementDashboardTemplateComponent activityStatusData={procurementAdminActivityStatusData} incomingColumn={procurementAdminDashboardRecentRequisitionsColumns} incomingData={procurementAdminDashboardRecentRequisitionsData}/>
    )
}
