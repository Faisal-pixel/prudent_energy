...
const ProcurementAdminRequestForQuotesTeamRequisitionsDetails = () => {
    ...
    return <>
        <div className="container h-full overflow-y-auto px-5 pt-6 pb-5 flex flex-col space-y-5">
            ...
            <div className="flex space-x-3 text-sm">
                ...
                <span className="text-greyDark">Team Requisitions</span>
                <span className="self-center text-greyDark"><BreadCrumbRightNavigationSVG /></span>
            ...
            <div className="space-x-3">
                <button type="button" className="px-7 py-1 border-2 border-primaryBlue rounded-md hover:text-white hover:bg-primaryBlue">Approve</button>
                <button type="button" className="px-7 py-1 border-2 border-primaryBlue rounded-md hover:text-white hover:bg-primaryBlue">Reject</button>
            </div>
            {/* General Toggle */}
            <GeneralTemplate />
...
export default ProcurementAdminRequestForQuotesTeamRequisitionsDetails;