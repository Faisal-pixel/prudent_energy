...
const ProcurementAdminMyPurchaseContractsDetails = () => {
    const {uploadedFilesPurchaseContracts} = useContext(ProcurementAdminContext)
    return (
...
export default ProcurementAdminMyPurchaseContractsDetails;