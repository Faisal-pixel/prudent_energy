...
const SelectDropdown = ({optionsData, setUpdateSelect, otherClasses}) => {
    ...
    // data.option
    return <>
        <div className={`absolute bg-white bg-opacity-100 border border-greyDark shadow-sm rounded-md w-max ${otherClasses === undefined && "-left-[0.5px] top-8"} z-10  ${otherClasses}`}>
            {
