...
const ActivityStatus = ({activityStatus}) => {
    ...
    return (
        <div className="bg-primaryBlue flex py-5 px-2 flex-col space-y-5 basis-[199px] hover:cursor-pointer !mr-0.5 mb-1 flex-1 lg:mr-0" onClick={goTo !== "" ? handleClick : null}>
